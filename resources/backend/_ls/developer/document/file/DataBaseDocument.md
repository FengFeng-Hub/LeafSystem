...
| **字段名称** | **中文名称** | **数据类型** | **null** | **默认** | **备注** |
| ------------ | ------------ | ------------ | -------- | -------- | -------- |
| dict_id      | 字典代码     | int          | n        |          | 主键     |
| dict_type    | 字典类型     | varchar(50)  | n        |          | 唯一索引 |
| dict_desc    | 字典描述     | varchar(100) |          |          |          |

#### sys_dict_data 字典数据表

| **字段名称** | **中文名称** | **数据类型** | **null** | **默认** | **备注** |
| ------------ | ------------ | ------------ | -------- | -------- | -------- |
| dict_data_id | 字典数据代码 | int          | n        |          | 主键     |
| dict_type    | 字典类型     | varchar(50)  | n        |          |          |
| value        | 键值         | varchar(50)  | n        |          |          |
| label        | 标签         | varchar(100) | n        |          |          |
| sort         | 排序         | int          |          |          |          |